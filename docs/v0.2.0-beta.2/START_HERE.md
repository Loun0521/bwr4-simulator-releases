# BWR-4 Simulator v0.2.0-beta.2 — 처음 시작하기
...
https://github.com/Loun0521/bwr4-simulator-source-beta/releases/tag/source-v0.2.0-beta.1
...
```bash
tar -xzf BWR4-Simulator-v0.2.0-beta.2-Linux-x64.tar.gz
cd BWR4-Simulator-v0.2.0-beta.2-Linux-x64
./BWR4-Simulator
```
